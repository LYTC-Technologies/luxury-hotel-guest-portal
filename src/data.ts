...
export const sampleGuest = {
  ...
  roomType: 'جناح ديلوكس الملكي بإطلالة بانورامية',
  bedType: 'سرير ملكي فاخر + أريكة استرخاء',
  guestCount: 2,
  childrenCount: 1,
  loyaltyPoints: 12450,
  balanceDue: 3840,
  ...
  taxes: 1865,
  discounts: 750,
  promoCode: 'AMAN-GOLD-2026',
  reservationStatus: 'مؤكد' as const,
  email: 'sulaiman.alsaud@mail.sa',
...
export const foodItems: FoodItem[] = [
  ...
  {
    id: 'f2',
    name: 'شكشوكة بالجبن الحلومي والزعتر',
    description: 'بيض طازج مطهو مع طماطم مشوية، فلفل حلو، جبن حلومي ذائب، وزيت زيتون بكر مع خبز صاج ساخن.',
    price: 95,
    image: 'https://images.unsplash.com/photo-1589302168068-964664d93aa0?auto=format&fit=crop&w=800&q=80',
    category: 'breakfast',
    isVegetarian: true,
    isHalal: true,
  },
  {
    ...
    description: 'لحم حاشي طري مطهو ببطء على طريقة المندي التقليدية مع أرز بسمتي معطر بالزعفران الكشميري والمكسرات المحمصة.',
    price: 295,
  ...
  {
    id: 'f4',
    name: 'سلطة الكينوا بالأفوكادو والرمان',
    description: 'كينوا عضوية مع أفوكادو طازج، رمان يمني، جوز محمص، وصلصة ليمون بالزعتر.',
    price: 120,
  ...
  },
  {
    ...
    description: 'قطعة ستيك واغيو يابانية مشوية على حجر بركاني مع مرق الترافل الأسود وبطاطس مخفوقة وهليون مشوي.',
    price: 820,
  ...
  {
    id: 'f6',
    name: 'سمك الهامور المشوي بالبهارات العربية',
    description: 'فيليه هامور طازج مشوي مع أرز بالزعفران وصلصة الطحينة والليمون الأسود.',
    price: 340,
  ...
  },
  {
    ...
    description: 'جبنة كريمية بنكهة الزعفران والهيل مغطاة بجيلي ماء الورد وأوراق الذهب القابلة للأكل.',
    price: 95,
  ...
  },
  {
    ...
    description: 'رقائق عجين ذهبية بالحليب العضوي والمكسرات الفاخرة مع قشدة طازجة وفستق حلبي.',
    price: 85,
  ...
  },
  {
    ...
    description: 'عصير باشن فروت طازج بماء الورد الطائفي وعسل السدر الطبيعي.',
    price: 75,
  ...
  {
    id: 'f10',
    name: 'ماء جوز الهند الطبيعي المثلج',
    description: 'ماء جوز هند طازج من ثمار ناضجة مع نعناع طازج وثلج مجروش.',
    price: 55,
  ...
  },
  {
    ...
    description: 'دلة قهوة شقراء فاخرة بالهيل الطبيعي والزعفران مع تمور الخلاص والسكري.',
    price: 110,
  ...
  {
    id: 'f12',
    name: 'لاتيه الفانيلا بالزعفران',
    description: 'إسبريسو إيطالي مع حليب مبخر بنكهة الفانيلا المدغوقة ورشة زعفران.',
    price: 65,
  ...
  {
    id: 'f13',
    name: 'وجبة الأطفال الملكية الصغيرة',
    description: 'دجاج مشوي طري مع بطاطس مقلية ذهبية وعصير برتقال طازج وآيس كريم فانيلا.',
    price: 75,
  ...
  {
    id: 'f14',
    name: 'معكرونة الجبن للأطفال',
    description: 'معكرونة طرية بصلصة الجبن الكريمي مع خضروات مطهية على البخار.',
    price: 55,
  ...
  {
    id: 'f15',
    name: 'مكسرات مشكلة محمصة فاخرة',
    description: 'تشكيلة من اللوز والكاجو والفستق المحمص بملح البحر والهيل.',
    price: 45,
    image: 'https://images.unsplash.com/photo-1599599810769-bcde5a160d2c?auto=format&fit=crop&w=800&q=80',
    category: 'snacks',
    isVegetarian: true,
    isGlutenFree: true,
  },
  {
    id: 'f16',
    name: 'سندويش كلوب بالدجاج المشوي',
    description: 'سندويش ثلاثي الطبقات بالدجاج المشوي والخس والطماطم وصلصة الثوم الكريمية.',
    price: 85,
...
export const offers: Offer[] = [
  {
    id: 'o1',
    title: 'ترقية الجناح إلى فيلا ملكية بحوض سباحة خاص',
    description: 'ترقية حصرية لفيلا الأمان المستقلة مع مسبح خاص مدفأ ومساعد شخصي مجاني على مدار الساعة.',
  ...
  {
    id: 'o2',
    title: 'باقة العافية الشاملة للاسترخاء وإعادة التوازن',
    description: 'احجز ليلتين واحصل على جلسة سبا مجانية لشخصين مع إفطار ملكي وتسجيل مغادرة متأخر حتى 4 مساءً.',
    image: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80',
  ...
  {
    id: 'o3',
    title: 'خصم المطعم الإيطالي الفاخر ألبا',
    description: 'حجز طاولة بإطلالة مميزة مع مشروب ترحيبي ذهبي وعشاء من 5 أطباق من الطاهي الحائز على نجوم ميشلان.',
    image: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80',
    discount: 'خصم 20% على قائمة الطعام',
    code: 'ALBA-20',
  },
];
